...
DEFINES=-D WINNT=1 -D KMALLOC_DEBUG=1 -D __KERNEL__=1 -D __BYTE_ORDER=1 -D __LITTLE_ENDIAN=1 -D __LITTLE_ENDIAN_BITFIELD -D COMPAT_HAVE_BOOL_TYPE=1  -D CONFIG_KREF_DEBUG=1 -D __MINGW64__=1 -DKBUILD_MODNAME='"drbd"'
...
CFLAGS_FOR_DEVICE_MAPPER=-g -Wall $(OPTIMIZE) $(CFLAGS_FOR_DRIVERS) $(DEFINES_FOR_DEVICE_MAPPER) $(DEVICE_MAPPER_INCLUDES) $(MINGW_INCLUDES)
