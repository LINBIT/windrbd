...
; TODO: Uninstall should remove WinDRBDRootXXX registry keys (2).
...
Filename: "{app}\cygrunsrv"; Parameters: "-I windrbdlog -p {code:WinDRBDRootDirCygwin}/usr/sbin/windrbd.exe -a log-server -1 {code:WinDRBDRootDirCygwin}/windrbd-kernel.log -2 {code:WinDRBDRootDirCygwin}/windrbd-kernel.log -t manual"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated shellexec
Filename: "{app}\cygrunsrv"; Parameters: "-I windrbdumhelper -p {code:WinDRBDRootDirCygwin}/usr/sbin/windrbd.exe -a user-mode-helper-daemon -1 {code:WinDRBDRootDirCygwin}/windrbd-umhelper.log -2 {code:WinDRBDRootDirCygwin}/windrbd-umhelper.log -t manual"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated shellexec
...
Filename: "{code:WinDRBDRootDir}\usr\sbin\windrbd.exe"; Parameters: "remove-bus-device windrbd.inf"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated shellexec; RunOnceId: "RemoveBusDeviceWinDRBD"
